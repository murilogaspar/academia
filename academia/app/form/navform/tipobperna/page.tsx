...
export default function TipoBPerna() {
  const [dados, setDados] = useState<ExercItem[]>([
    { exercicio: "AGC SMITH", series: "", reps: "", carga: "", checked: false },
    { exercicio: "MESA FLEXORA", series: "", reps: "", carga: "", checked: false },
    { exercicio: "HACK", series: "", reps: "", carga: "", checked: false },
    { exercicio: "LEG 180° (+PANTURRILHA)", series: "", reps: "", carga: "", checked: false },
    { exercicio: "CAD. FLEXORA", series: "", reps: "", carga: "", checked: false },
    { exercicio: "EXTENSORA", series: "", reps: "", carga: "", checked: false },
  ]);
  ...
  return (
    <div className="w-full p-4 flex flex-col gap-6">
      <h2 className="text-xl font-bold mb-4">Treino B</h2>
